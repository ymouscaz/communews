...
urlpatterns = [
    ...
    path('verify/<uuid:verification_code>', views.verify,
         name="accounts_verify"),
    ...
    path('accounts/password-change/',
         auth_views.PasswordChangeView.as_view(template_name='accounts/password_change_form.html'),  # NOQA
         name="password_change"),
    path('accounts/password-change-done/',
          auth_views.PasswordChangeDoneView.as_view(template_name='accounts/password_change_done.html'),  # NOQA
          name="password_change_done"),

    path('accounts/password-forgotten/', views.password_forgotten,
          name="password_forgotten"),
    path('accounts/password-forgotten/<str:verification_code>',
          views.password_forgotten, name="password_forgotten"),
